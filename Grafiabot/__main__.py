...
import sys
import traceback
import Bestie_Robot.modules.sql.users_sql as sql
...
from Bestie_Robot.modules import ALL_MODULES
from Bestie_Robot.modules.helper_funcs.chat_status import is_user_admin
from Bestie_Robot.modules.helper_funcs.alternate import typing_action
from Bestie_Robot.modules.helper_funcs.misc import paginate_modules
...
*Hola! {},*
*I am an Anime themed advanced group management bot with a lot of  Features.*
➖➖➖➖➖➖➖➖➖➖➖➖➖
• *Uptime:* `{}`
• `{}` *users, across* `{}` *chats.*
➖➖➖➖➖➖➖➖➖➖➖➖➖
...
buttons = [
    [
                   ...
                   [
                       ...
                       InlineKeyboardButton(text="🎭 My Master", url="https://maddietherock.github.io/"),
                       InlineKeyboardButton(text="[► Inline ◄]", switch_inline_query_current_chat=""),
                     ],
                    [                  
                       InlineKeyboardButton(                         
                             text="🚑 Support",
                             url="https://t.me/Alonesupportchat"),
                       InlineKeyboardButton(
                             text="📢 Updates",
                             url="https://t.me/Aloneupdates")
                     ],
    ]
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Bestie_Robot.modules." + module_name)
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="📢 Updates",
                            url="https://telegram.dog/MaddieTheRock",
                        ),
                    ]
                ]
            ),
...
def main():
    ...
    if WEBHOOK:
        ...
        LOGGER.info(f"Bestie started, Using long polling. | BOT: [@{dispatcher.bot.username}]")
