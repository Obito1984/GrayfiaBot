...
import Bestie_Robot.modules.sql.welcome_sql as sql
import Bestie_Robot
...
from Bestie_Robot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Bestie_Robot.modules.helper_funcs.msg_types import get_welcome_type
from Bestie_Robot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from Bestie_Robot.modules.log_channel import loggable
from Bestie_Robot.modules.sql.global_bans_sql import is_user_gbanned
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_chat.send_message(
                    "Oh, My Owner just joined!", reply_to_message_id=reply
                )
            ...
            # Welcome Whitelisted
                ...
                update.effective_chat.send_message(
                    "OH YEAH! A C-RANK Hunter just joined!", reply_to_message_id=reply
                )

            # Welcome Tigers
            elif new_mem.id in WOLVES:
                update.effective_chat.send_message(
                    "JEZZ! A D-RANK Hunter just joined!", reply_to_message_id=reply
                )
