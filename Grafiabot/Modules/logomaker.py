...
from Bestie_Robot import OWNER_ID, SUPPORT_CHAT
from Bestie_Robot.events import register
from Bestie_Robot import telethn
...
async def lego(event):
    ...
    try:
        ...
        fillcolor = "black"
        shadowcolor = "blue"
        fnt = glob.glob("./Bestie_Robot/utils/Logo/*")
        ...
        await telethn.send_file(
            event.chat_id, file=fname, caption=f"Made by @Bestie_Robot"
        )
        await pesan.delete()
