...
from Bestie_Robot.modules.helper_funcs.extraction import extract_user_and_text
from Bestie_Robot.modules.helper_funcs.string_handling import extract_time
from Bestie_Robot.modules.log_channel import gloggable, loggable
...
def ban(update: Update, context: CallbackContext):  # sourcery no-metrics
    ...
    if message.reply_to_message and message.reply_to_message.sender_chat:
        ...
        if r:
            message.reply_text(
                "Channel {} was banned from {}".format(
