...
import Bestie_Robot.modules.sql.notes_sql as sql
from Bestie_Robot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from Bestie_Robot.__main__ import DATA_IMPORT
from Bestie_Robot.modules.helper_funcs.chat_status import user_admin
from Bestie_Robot.modules.helper_funcs.alternate import typing_action

# from Bestie_Robot.modules.rules import get_rules
import Bestie_Robot.modules.sql.rules_sql as rulessql

# from Bestie_Robot.modules.sql import warns_sql as warnssql
import Bestie_Robot.modules.sql.blacklist_sql as blacklistsql
from Bestie_Robot.modules.sql import disable_sql as disabledsql

# from Bestie_Robot.modules.sql import cust_filters_sql as filtersql
# import Bestie_Robot.modules.sql.welcome_sql as welcsql
import Bestie_Robot.modules.sql.locks_sql as locksql
from Bestie_Robot.modules.connection import connected
...
def export_data(update, context):
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Bestie_Robot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Bestie_Robot-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("Bestie_Robot{}.backup".format(chat_id))  # Cleaning file
