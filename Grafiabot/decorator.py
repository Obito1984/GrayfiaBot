...
from Bestie_Robot import BOT_USERNAME, dp
from Bestie_Robot.config import get_bool_key
from Bestie_Robot.modules.error import parse_update
from Bestie_Robot.utils.filters import ALL_FILTERS
...
for module_name in ALL_FILTERS:
    ...
    imported_module = import_module("Bestie_Robot.utils.filters." + module_name)
